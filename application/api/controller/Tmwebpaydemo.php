...
class Tmwebpaydemo extends Controller
{
    /*生成签名，支付宝、微信兼容*/
    public function paySign(){
       $aa =  signH5Wechat("32114421",1,input('server.REQUEST_SCHEME') . '://' . input('server.SERVER_NAME')."/api/tmwebpaydemo/notify","商品标题");
       dump($aa);
       // webH5Alipay("321144",0.01,input('server.REQUEST_SCHEME') . '://' . input('server.SERVER_NAME')."/api/tmwebpaydemo/notify","商品标题","https://shop.360tianma.com");
        return;
        //判断请求方式以及请求参数
