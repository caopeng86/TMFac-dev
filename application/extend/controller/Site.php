...
class Site extends Base
{
    ...
    public function getSystemInfo(){
        ...
        if(!$info){
            ...
            $result = $UpdateController->checkLicense();
            $info['license_status'] = $result['msg'];
            if(!empty($result['data'])){
                $info['license'] = $result['data']['status'];
                $info['license_start_time'] = $result['data']['start_time'];
                $info['license_end_time'] = $result['data']['end_time'];
            }
            //当前附件根目录
            //当前附件尺寸
