...
class Branch extends Base
{
    ...
    public function getBranchList(){
        ...
        return reJson(200, '获取组织机构列表成功', $branchList);
    }
    ...
    public function updateUserBranch(){
        ...
        foreach ($userCode as $value){
            ...
            if($re === false){
                ...
                Db::rollback();
                return reJson(500, '移动部门失败', []);
            }
        }
        Db::commit();
        Logservice::writeArray(['inputData'=>$inputData], '批量移动部门');
        return reJson(200, '移动部门成功', []);
    }
    ...
    public function deleteBranch(){
        ...
        if($son){
            return reJson(500, '该部门下有子部门,不能删除', []);
        }
        ...
        if($user > 0){
            return reJson(500, '该部门下有用户,不能删除', []);
        }
